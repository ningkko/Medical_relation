...
rx_norms_df = pd.read_csv("../mapping data/rxnorm/rxnorm_string.csv")
rx_norm_strings_new = rx_norms_df["STR"].apply(lambda x: x.lower().replace(" / ", "/")).to_list()
...
with open('output/cui_str_dict_updated.json', 'w') as fp:
