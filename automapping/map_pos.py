...
pos = "/n/data1/hsph/biostat/celehs/yih798/automapping/source/sample/pos_train.csv"
...
poolfile = "/n/data1/hsph/biostat/celehs/yih798/automapping/output/pos_train.txt"
...
print("%i positive sample found, %i samples not found"%(i,len(mapset)-i))